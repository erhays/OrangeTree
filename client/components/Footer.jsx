    ...
    return (
        <footer className="site-footer">
            <div className="site-footer-inner">
                <Link to="/" className="site-footer-logo" aria-label="OrangeTree Detailing">
                    <svg width="100" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 388.47 391.28">
                        <defs><style>{`.ot-footer-cls-1{stroke:currentColor;stroke-linecap:round;stroke-linejoin:round;stroke-width:7px}`}</style></defs>
                        <g>
                            <g>
                            ...
                            <path className="ot-footer-cls-1" d="M297.67,31.4c-39.83-1.48-50.58,36.93-53.15,50.74-.29,1.56,1.58,2.58,2.74,1.49,4.5-4.2,12.64-11.24,20.03-14.68,17.4-8.1,34.04,5.35,51.59-4.31,17.28-9.51,9.75-32.1-21.21-33.25Z"/>
                        </g>
                        <g>
