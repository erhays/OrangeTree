...
export default function ContentPage() {
    ...
    return (
        <div style={{ padding: '2rem', maxWidth: '680px' }}>
            ...
            <div style={{ background: '#fff', border: '1px solid #e5e7eb', borderRadius: '4px', padding: '1.5rem', boxShadow: '0 2px 6px rgba(0,0,0,0.06)', marginBottom: '1.5rem' }}>
            ...
            {loading ? (
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                    {posts.map(post => (
                        <div key={post.id} style={{ background: '#fff', border: '1px solid #e5e7eb', borderRadius: '4px', padding: '1.25rem 1.5rem' }}>
                            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: '1rem' }}>
                                ...
                                <div style={{ display: 'flex', gap: '0.5rem', flexShrink: 0 }}>
                                    <button
                                        ...
                                        style={{ padding: '0.35rem 0.75rem', border: '1px solid #e5e7eb', borderRadius: '4px', fontSize: '0.8rem', color: '#555', background: '#fff', cursor: 'pointer' }}
                                    >
                                        Edit
                                    </button>
                                    <button
                                        onClick={() => handleDelete(post.id)}
                                        style={{ padding: '0.35rem 0.75rem', border: '1px solid #fee2e2', borderRadius: '4px', fontSize: '0.8rem', color: '#ef4444', background: '#fff', cursor: 'pointer' }}
                                    >
                                        Delete
                                    </button>
                                </div>
